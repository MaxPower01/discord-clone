...
export default class ValidationService {
  ...
  private _ajv: Ajv | null = null;
  private static get ajv(): Ajv {
    const { instance } = ValidationService;
    if (instance._ajv === null)
      instance._ajv = new Ajv({
        allowUnionTypes: true,
      });
    return instance._ajv;
  }
  ...
  public parseType<T>(
    ...
    try {
      ...
      const validate = ValidationService.ajv.compile<T>(jsonSchema);
